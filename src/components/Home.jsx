    ...
    >
      ...
      <div className="max-w-[1000px] w-full h-full py-20 mx-auto flex flex-col md:flex-row items-center md:pt-36">
        ...
        <motion.div
          ...
          className="overflow-hidden absolute flex justify-center items-center bottom-0 top-0 md:right-0 md:pt-36 w-full md:w-auto lg:w-[400px] md:ml-auto"
        >
          <img
            src="/assets/rizwan-bgcopy.png"
            alt="Riswan's Image desktop view"
            className="object-cover w-full md:h-[350px] lg:h-full h-auto md:block hidden"
            style={{
              opacity: 1,
              objectFit: "cover", 
              transform: "scale(1)", 
